...
public class Rule {
	...
	// Method that handles new Inputs for each rule by saving them in the
	// listOfLastInputs and forwarding them to the updateState method
	...
	// fills the stateOutputList with the information from the SMPanel when the rule
	// is created
